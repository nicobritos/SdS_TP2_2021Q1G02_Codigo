...
public abstract class ParticleParser {
    public static Pair<List<CellularParticle>, Integer> parseParticles(String filePath, boolean is3D) throws IOException {
        List<CellularParticle> particles;
        ...
        try {
            ...
            while (myReader.hasNextLine()) {
                ...
                CellularParticle particle = new CellularParticle(i, Double.parseDouble(info[0]), Integer.parseInt(info[1]), Integer.parseInt(info[is3D ? 5 : 4]) == 1);
